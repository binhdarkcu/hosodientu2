...
class ListDoLoangXuong extends React.Component {
...
ListDoLoangXuong.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(ListDoLoangXuong));
